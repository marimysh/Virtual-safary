...
abstract class Animal
{
  ...
  public Animal(Animal value)
  {
    ...
    this.gender = value.getGender().equals("man");
  }
  ...
  public Animal(String[] value)
  {
    ...
    this.gender = value[4].equals("man");
  }
  ...
  public void setPhotoMini(Image value)
  {
    photoMini = value;
  }
}
...
class Wolf extends Animal
{
  ...
  /**
   * @return может съесть за раз столько мяса волк
   */
  protected int countFood()
  {
    return 27;
